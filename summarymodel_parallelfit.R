...
gplvmpyout <- read.csv('GPLVMpyOut_se_n1000.csv')
summary(gplvmpyout)
...
gplvmpyout_fixpar <- read.csv('GPLVMpyOut_se_fixedparams_n1000.csv')
...
compare_table <- readRDS('hsgp_simout_se_n1000_wideprior.rds')
